...
for rep in range(1, num_replicates + 1):
    ...
    #         folder = f"/media/rodolfo/FE761CFD761CB7FB/Ubuntu/Simulaciones/outputs/MPSA_1000/rule{param_idx + 1}_HM{factor}_rep{rep}"
        ...
        for j in range(i + 1, len(rules_to_modify)):
            for factor_i in half_max_factors:
                for factor_j in half_max_factors:
                    ...
                    folder = f"/media/rodolfo/FE761CFD761CB7FB/Ubuntu/Simulaciones/outputs/1vs4/rule{i + 1}_vs_rule{j + 4}_HM{factor_i}_{factor_j}_rep{rep}"
